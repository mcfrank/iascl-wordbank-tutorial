...
* The stuff at the very top of the document is its YAML header, which contains basic information about the document.
...
To illustrate some of these functions (or "verbs"), we will use an old version of the English (American) Words & Sentences dataset from Wordbank.
